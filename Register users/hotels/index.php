...
$sql1 = "SELECT * FROM hotel_categories ";
...
$sql2 = "SELECT * FROM hotels
          LEFT JOIN
          stars ON stars.id = hotels.h_id 
          ORDER BY stars DESC";
          // SELECT hotels.*, stars.stars as stars FROM hotels LEFT JOIN stars ON hotels.h_id = stars.id ORDER BY stars.stars DESC;
// $sql2 = "SELECT * FROM hotels ";
$result2 = mysqli_query($conn, $sql2);
 //$data2 = mysqli_fetch_assoc($result2);

// $name= $data2['dist_name'];
// echo $name;
//die();
// $sql_adm = mysqli_query($conn, "select COUNT(stars) as total FROM ratingsystem_hotel where h_id = 'hotel manager'; ");
// $adm = mysqli_fetch_assoc($sql_adm);

$sql22 = "SELECT * FROM stars ";
...
<section style="margin-top:-4%;"> 
  ...
  <div class="sidenav">
     <h3 style="color:white;text-align: center;">Select District</h3> 
      ...
      ?> 
      <a href="categories/index.php?categories_id=<?php echo $data1['categories_id'];?>"><?php echo $data1['dist_name']?></a> 
      <?php
        }
      ?>
  </div>
                            ...
                            <div class="row">
                               ...
                               <div class="col-md-2 mt-5">
                                 ...
                                 <p><bold><?php echo $data2['stars'];
                                  ?> </bold></p>
                                 <a href="categories/hotel.php?h_id=<?php echo $data2['h_id'];?>" class="btn btn-outline-primary w-100 " style="font-size:16px;"> more details</a> 
