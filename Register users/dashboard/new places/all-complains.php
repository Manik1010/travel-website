...
$sql = "select * from new_place_complains
...
<table class="table table-striped table-bordered"> 
         		...
         		<tbody>
         			...
         			<tr>
	         			...
	         			<td width="100">
                            <a href="cancel-complain.php?id=<?php echo $row['id']; ?>"class=" btn btn-sm btn-outline-danger w-100" onclick="return confirm('Are you sure?')">cancle</a>
	         			</td>
                        <?php }else{?>
                            <td>
                                 <a href="remove-complain.php?id=<?php echo $row['id']; ?>"class=" btn btn-sm btn-outline-danger w-100" onclick="return confirm('Are you sure?')">remove</a>
                            </td>
