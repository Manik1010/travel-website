...
if(isset($_POST['submit'])){
  ...
  $stock_product = $_POST['total_products'];
    ...
    $sql = "INSERT INTO shop_products( category_id, subcategory_id, productTitle, productDescription, actualPrice, discount, salesPrice, image,image2,image3,stock) VALUES ('$category_id','$subcategory_id','$productTitle','$productdescription',' $actual_price','$discount',' $sales_price','$image','$image2','$image3','$stock_product')";
              ...
              <form  id="quickForm" action="" method="POST" enctype="multipart/form-data">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <textarea class="form-control" id="editor" name="productdescription" rows="10"></textarea>
                    
                  </div>
                  <div class="form-group">
                    <label for="total_products">Total products</label>
                    <input type="number" class="form-control" name="total_products" id="total_products" placeholder="How many of this product are there in total">
                  </div>
                  <div class="form-group">
                    <label for="actual_price">Actual Price</label>
                    <input type="text" class="form-control" name="actual_price" id="actualPrice" placeholder="product actual price">
                  </div>
                  <div class="form-group">
                    <label for="discount">Discount</label>
                    <input type="number" class="form-control" name="discount" id="discount" placeholder="Enter discount from 1-100%">
                  </div>
                  <div class="form-group">
                    <label for="sales_price">Sales Price</label>
                    <input type="text" class="form-control" name="sales_price" id="salesPrice" placeholder="sales price of your product">
                  </div>
